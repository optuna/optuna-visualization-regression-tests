...
```
$ python visual_regression_tests.py plot_optimization_history
```
...
```
$ python visual_regression_tests.py plot_slice
```
...
```
$ python visual_regression_tests.py plot_pareto_front
```
...
```
$ python visual_regression_tests.py plot_contour
```
